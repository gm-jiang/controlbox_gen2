...
public class xdc_runtime
{
    ...
    void Core$$CONSTS()
    {
        ...
        om.bind("xdc.runtime.Core.createObject", new Extern("xdc_runtime_Core_createObject__I", "xdc_Ptr(*)(xdc_runtime_Core_ObjDesc*,xdc_Ptr,xdc_Ptr,xdc_Ptr,xdc_SizeT,xdc_runtime_Error_Block*)", true, false));
        om.bind("xdc.runtime.Core.constructObject", new Extern("xdc_runtime_Core_constructObject__I", "xdc_Ptr(*)(xdc_runtime_Core_ObjDesc*,xdc_Ptr,xdc_Ptr,xdc_Ptr,xdc_SizeT,xdc_runtime_Error_Block*)", true, false));
