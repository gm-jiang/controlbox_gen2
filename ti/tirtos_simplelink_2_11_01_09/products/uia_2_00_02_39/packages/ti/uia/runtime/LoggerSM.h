...
/* write__I */
#define ti_uia_runtime_LoggerSM_write ti_uia_runtime_LoggerSM_write__I
xdc__CODESECT(ti_uia_runtime_LoggerSM_write__I, "ti_uia_runtime_LoggerSM_write")
__extern xdc_Void ti_uia_runtime_LoggerSM_write__I( ti_uia_runtime_LoggerSM_Object *obj, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8 );
...
/* Handle_name */
static inline String ti_uia_runtime_LoggerSM_Handle_name( ti_uia_runtime_LoggerSM_Handle inst )
{
