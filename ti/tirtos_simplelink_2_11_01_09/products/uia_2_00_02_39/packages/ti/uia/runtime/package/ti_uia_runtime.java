...
public class ti_uia_runtime
{
    ...
    void LoggerSM$$CONSTS()
    {
        ...
        om.bind("ti.uia.runtime.LoggerSM.write", new Extern("ti_uia_runtime_LoggerSM_write__I", "xdc_Void(*)(ti_uia_runtime_LoggerSM_Object*,xdc_runtime_Log_Event,xdc_Bits16,xdc_IArg,xdc_IArg,xdc_IArg,xdc_IArg,xdc_IArg,xdc_IArg,xdc_IArg,xdc_IArg)", true, false));
    ...
    void LoggerSM$$SINGLETONS()
    {
        ...
        vo.bind("write", om.findStrict("ti.uia.runtime.LoggerSM.write", "ti.uia.runtime"));
