...
package/lib/lib/debug/boot/cmain.orm3: cmain.s lib/debug/boot.arm3.mak
	...
	$(RM) $@
	@$(MSG) asmrm3 $< ...
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/iasmarm -S --cpu Cortex-M3 --endian little  -Dxdc_target_name__=M3 -Dxdc_target_types__=iar/targets/arm/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_7_20_1   $(XDCINCS)  -o $@  $<
