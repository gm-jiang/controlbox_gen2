...
package/lib/lib/boot/boot.om3g: boot.asm lib/boot.am3g.mak
	...
	$(RM) $@
	@$(MSG) asmm3g $< ...
	$(gnu.targets.arm.M3.rootDir)/bin/arm-none-eabi-gcc -c -x assembler-with-cpp  -Wa,-mcpu=cortex-m3 -Wa,-mthumb  -Dxdc_target_name__=M3 -Dxdc_target_types__=gnu/targets/arm/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_4_7_4   $(XDCINCS)  -o $@ $<
	-@$(FIXDEP) $@.dep $@.dep
