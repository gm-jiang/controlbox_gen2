...
public class ti_sysbios_hal
{
    ...
    void Seconds$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_hal_Seconds_Module__startupDone__E", "ti_sysbios_hal_Seconds_get__E", "ti_sysbios_hal_Seconds_set__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void SecondsCallback$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_hal_SecondsCallback_Module__startupDone__E", "ti_sysbios_hal_SecondsCallback_get__E", "ti_sysbios_hal_SecondsCallback_set__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void SecondsClock$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_hal_SecondsClock_Module__startupDone__E", "ti_sysbios_hal_SecondsClock_get__E", "ti_sysbios_hal_SecondsClock_set__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
