...
public class ti_sysbios_rom
{
    ...
    {
        // module ROM
        om.bind("ti.sysbios.rom.ROM.CC2650", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2650", 0));
        om.bind("ti.sysbios.rom.ROM.CC1350", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC1350", 1));
        om.bind("ti.sysbios.rom.ROM.CC2650_FLASH", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2650_FLASH", 2));
        om.bind("ti.sysbios.rom.ROM.TM0SXX", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.TM0SXX", 3));
        om.bind("ti.sysbios.rom.ROM.POTENZA", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.POTENZA", 4));
    }
    ...
    void ROM$$TYPES()
    {
        ...
        po.addFld("romName", (Proto)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), $$UNDEF, "wh");
    ...
    void ROM$$SINGLETONS()
    {
        ...
        vo.bind("CC2650_FLASH", om.findStrict("ti.sysbios.rom.ROM.CC2650_FLASH", "ti.sysbios.rom"));
        vo.bind("TM0SXX", om.findStrict("ti.sysbios.rom.ROM.TM0SXX", "ti.sysbios.rom"));
        vo.bind("POTENZA", om.findStrict("ti.sysbios.rom.ROM.POTENZA", "ti.sysbios.rom"));
