...
public class ti_sysbios_family_arm_msp432
{
    ...
    void ClockFreqs$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.msp432.ClockFreqs.Clock_MCLK", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.msp432.ClockFreqs.Clock", "ti.sysbios.family.arm.msp432"), "ti.sysbios.family.arm.msp432.ClockFreqs.Clock_MCLK", 3));
    ...
    void ClockFreqs$$SINGLETONS()
    {
        ...
        vo.bind("Clock_MCLK", om.findStrict("ti.sysbios.family.arm.msp432.ClockFreqs.Clock_MCLK", "ti.sysbios.family.arm.msp432"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_msp432_ClockFreqs_Module__startupDone__E", "ti_sysbios_family_arm_msp432_ClockFreqs_getFrequency__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
