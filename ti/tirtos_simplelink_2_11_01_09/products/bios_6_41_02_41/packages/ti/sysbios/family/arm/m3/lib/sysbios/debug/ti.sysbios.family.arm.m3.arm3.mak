...
package/lib/lib/sysbios/debug/ti.sysbios.family.arm.m3/Clobber_asm_iar.orm3: Clobber_asm_iar.sv7M lib/sysbios/debug/ti.sysbios.family.arm.m3.arm3.mak
	...
	$(RM) $@
	@$(MSG) asmrm3 $< ...
	LC_ALL=C $(iar.targets.arm.M3.rootDir)/bin/iasmarm -S --cpu Cortex-M3 --endian little  -Dxdc_target_name__=M3 -Dxdc_target_types__=iar/targets/arm/std.h -Dxdc_bld__profile_debug -Dxdc_bld__vers_1_0_7_20_1  -Dti_sysbios_BIOS_smpEnabled__D=FALSE  $(XDCINCS)  -o $@  $<
