...
public class ti_sysbios_family_arm_cc32xx
{
    ...
    void TimestampProvider$$OBJECTS()
    {
        ...
        // decls 
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.cc32xx.TimestampProvider$$Module_State", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State", new Proto.Str(spo, false));
    }
    ...
    void Seconds$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.cc32xx.Seconds.getSeconds", new Extern("ti_sysbios_family_arm_cc32xx_Seconds_getSeconds__I", "xdc_UInt32(*)(xdc_Void)", true, false));
    }
    ...
    void Timer$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.cc32xx.Timer.postInit", new Extern("ti_sysbios_family_arm_cc32xx_Timer_postInit__I", "xdc_Int(*)(ti_sysbios_family_arm_cc32xx_Timer_Object*,xdc_runtime_Error_Block*)", true, false));
    ...
    void TimestampProvider$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State", "ti.sysbios.family.arm.cc32xx");
        sizes.clear();
        sizes.add(Global.newArray("timer", "UPtr"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void TimestampProvider$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc32xx.TimestampProvider$$Module_State", "ti.sysbios.family.arm.cc32xx");
        po.init("ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("timer", (Proto)om.findStrict("ti.sysbios.family.arm.cc32xx.Timer.Handle", "ti.sysbios.family.arm.cc32xx"), $$UNDEF, "w");
    }
    ...
    void TimestampProvider$$ROV()
    {
        ...
        vo.bind("Module_State$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc32xx.TimestampProvider$$Module_State", "ti.sysbios.family.arm.cc32xx");
    }
    ...
    void Seconds$$SINGLETONS()
    {
        ...
        vo.bind("getSeconds", om.findStrict("ti.sysbios.family.arm.cc32xx.Seconds.getSeconds", "ti.sysbios.family.arm.cc32xx"));
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_cc32xx_Seconds_Module__startupDone__E", "ti_sysbios_family_arm_cc32xx_Seconds_get__E", "ti_sysbios_family_arm_cc32xx_Seconds_set__E"));
    ...
    void TimestampProvider$$SINGLETONS()
    {
        ...
        vo.bind("Module_State", om.findStrict("ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State", "ti.sysbios.family.arm.cc32xx"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.cc32xx.TimestampProvider.Module_State", "ti.sysbios.family.arm.cc32xx"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
