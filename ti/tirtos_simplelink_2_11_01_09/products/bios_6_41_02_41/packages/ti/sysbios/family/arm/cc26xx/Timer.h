...
#define ti_sysbios_family_arm_cc26xx_Timer___VERS 160
...
__extern __FAR__ const CT__ti_sysbios_family_arm_cc26xx_Timer_Module__startupDoneFxn ti_sysbios_family_arm_cc26xx_Timer_Module__startupDoneFxn__C;
...
struct ti_sysbios_family_arm_cc26xx_Timer_Fxns__ {
    ...
    xdc_Void (*setNextTick)(ti_sysbios_family_arm_cc26xx_Timer_Handle, xdc_UInt32);
    xdc_Void (*start)(ti_sysbios_family_arm_cc26xx_Timer_Handle);
    xdc_Void (*stop)(ti_sysbios_family_arm_cc26xx_Timer_Handle);
    xdc_Void (*setPeriod)(ti_sysbios_family_arm_cc26xx_Timer_Handle, xdc_UInt32);
    ...
    xdc_Void (*getFreq)(ti_sysbios_family_arm_cc26xx_Timer_Handle, xdc_runtime_Types_FreqHz*);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_family_arm_cc26xx_Timer_Handle, xdc_UArg*);
    xdc_Void (*setFunc)(ti_sysbios_family_arm_cc26xx_Timer_Handle, ti_sysbios_interfaces_ITimer_FuncPtr, xdc_UArg);
    xdc_Void (*trigger)(ti_sysbios_family_arm_cc26xx_Timer_Handle, xdc_UInt32);
...
__extern xdc_Int ti_sysbios_family_arm_cc26xx_Timer_Instance_init__E(ti_sysbios_family_arm_cc26xx_Timer_Object *, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_cc26xx_Timer_Params *, xdc_runtime_Error_Block *);
...
__extern void ti_sysbios_family_arm_cc26xx_Timer_Instance_finalize__E( ti_sysbios_family_arm_cc26xx_Timer_Object* , int );
...
__extern xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__create__S( xdc_Ptr __oa, xdc_SizeT __osz, xdc_Ptr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_family_arm_cc26xx_Timer_Object__destruct__S, "ti_sysbios_family_arm_cc26xx_Timer_Object__destruct__S")
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Object__destruct__S( xdc_Ptr objp );
...
{
    return ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sysbios_family_arm_cc26xx_Timer_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C != NULL) *ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C = mask;
}
