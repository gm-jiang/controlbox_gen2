...
#define ti_sysbios_family_arm_cc26xx_Boot___VERS 160
...
__extern __FAR__ const CT__ti_sysbios_family_arm_cc26xx_Boot_Module__startupDoneFxn ti_sysbios_family_arm_cc26xx_Boot_Module__startupDoneFxn__C;
...
/* overrideDefaultBackdoorIOID */
#ifdef ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID__D
#define ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID (ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID__D)
#else
#define ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID (ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID__C)
typedef xdc_Bool CT__ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID;
__extern __FAR__ const CT__ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID__C;
#endif

/* alternateBackdoorIOID */
#ifdef ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID__D
#define ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID (ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID__D)
#else
#define ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID (ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID__C)
typedef xdc_UInt32 CT__ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID;
__extern __FAR__ const CT__ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID__C;
#endif
...
{
    return ti_sysbios_family_arm_cc26xx_Boot_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sysbios_family_arm_cc26xx_Boot_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_cc26xx_Boot_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_cc26xx_Boot_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sysbios_family_arm_cc26xx_Boot_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sysbios_family_arm_cc26xx_Boot_Module__diagsMask__C != NULL) *ti_sysbios_family_arm_cc26xx_Boot_Module__diagsMask__C = mask;
}
...
/* module prefix */
#define Boot_overrideDefaultBackdoorIOID ti_sysbios_family_arm_cc26xx_Boot_overrideDefaultBackdoorIOID
#define Boot_alternateBackdoorIOID ti_sysbios_family_arm_cc26xx_Boot_alternateBackdoorIOID
