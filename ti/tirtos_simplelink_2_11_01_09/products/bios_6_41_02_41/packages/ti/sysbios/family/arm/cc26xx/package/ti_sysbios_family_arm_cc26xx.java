...
public class ti_sysbios_family_arm_cc26xx
{
    ...
    void Power$$OBJECTS()
    {
        ...
        pkgV.bind("Power", vo);
        // decls 
        om.bind("ti.sysbios.family.arm.cc26xx.Power.Constraint", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.Constraint"));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.LatencyType", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.LatencyType"));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SleepState", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.SleepState"));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.Event", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.Event"));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NotifyResponse", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.NotifyResponse"));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.Status", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.Status"));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.TransitionState", new Proto.Enm("ti.sysbios.family.arm.cc26xx.Power.TransitionState"));
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.cc26xx.Power$$NotifyObj", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NotifyObj", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.cc26xx.Power$$ModuleView", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ModuleView", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.sysbios.family.arm.cc26xx.Power$$Module_State", new Proto.Obj());
        om.bind("ti.sysbios.family.arm.cc26xx.Power.Module_State", new Proto.Str(spo, false));
    }
    ...
    {
        // module Power
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SB_VIMS_CACHE_RETAIN", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.SB_VIMS_CACHE_RETAIN", xdc.services.intern.xsr.Enum.intValue(0x1L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SD_DISALLOW", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.SD_DISALLOW", xdc.services.intern.xsr.Enum.intValue(0x2L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SB_DISALLOW", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.SB_DISALLOW", xdc.services.intern.xsr.Enum.intValue(0x4L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.IDLE_PD_DISALLOW", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.IDLE_PD_DISALLOW", xdc.services.intern.xsr.Enum.intValue(0x8L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NEED_FLASH_IN_IDLE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.NEED_FLASH_IN_IDLE", xdc.services.intern.xsr.Enum.intValue(0x10L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NUMCONSTRAINTS", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.NUMCONSTRAINTS", xdc.services.intern.xsr.Enum.intValue(5L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.TOTAL", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.LatencyType", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.TOTAL", 0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.RESUME", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.LatencyType", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.RESUME", 1));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.STANDBY", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SleepState", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.STANDBY", xdc.services.intern.xsr.Enum.intValue(0x1L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ENTERING_STANDBY", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.ENTERING_STANDBY", xdc.services.intern.xsr.Enum.intValue(0x1L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ENTERING_SHUTDOWN", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.ENTERING_SHUTDOWN", xdc.services.intern.xsr.Enum.intValue(0x2L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.AWAKE_STANDBY", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.AWAKE_STANDBY", xdc.services.intern.xsr.Enum.intValue(0x4L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.AWAKE_STANDBY_LATE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.AWAKE_STANDBY_LATE", xdc.services.intern.xsr.Enum.intValue(0x8L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.XOSC_HF_SWITCHED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.XOSC_HF_SWITCHED", xdc.services.intern.xsr.Enum.intValue(0x10L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NUMEVENTS", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.NUMEVENTS", xdc.services.intern.xsr.Enum.intValue(5L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NOTIFYDONE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NotifyResponse", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.NOTIFYDONE", xdc.services.intern.xsr.Enum.intValue(0L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.NOTIFYERROR", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NotifyResponse", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.NOTIFYERROR", xdc.services.intern.xsr.Enum.intValue(om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NOTIFYDONE", "ti.sysbios.family.arm.cc26xx"))+1));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SOK", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.SOK", xdc.services.intern.xsr.Enum.intValue(0L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SOK_STATE_RESTORED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.SOK_STATE_RESTORED", xdc.services.intern.xsr.Enum.intValue(1L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.EFAIL", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.EFAIL", xdc.services.intern.xsr.Enum.intValue(2L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.EINVALIDPOINTER", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.EINVALIDPOINTER", xdc.services.intern.xsr.Enum.intValue(3L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ECHANGE_NOT_ALLOWED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.ECHANGE_NOT_ALLOWED", xdc.services.intern.xsr.Enum.intValue(4L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ETIMEOUT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.ETIMEOUT", xdc.services.intern.xsr.Enum.intValue(5L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.EBUSY", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.EBUSY", xdc.services.intern.xsr.Enum.intValue(6L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ACTIVE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TransitionState", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.ACTIVE", xdc.services.intern.xsr.Enum.intValue(0x1L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.ENTERING_SLEEP", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TransitionState", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.ENTERING_SLEEP", xdc.services.intern.xsr.Enum.intValue(0x2L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.EXITING_SLEEP", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TransitionState", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.EXITING_SLEEP", xdc.services.intern.xsr.Enum.intValue(0x3L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.SHUTDOWN", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TransitionState", "ti.sysbios.family.arm.cc26xx"), "ti.sysbios.family.arm.cc26xx.Power.SHUTDOWN", xdc.services.intern.xsr.Enum.intValue(0x4L)+0));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.standbyPolicy", new Extern("ti_sysbios_family_arm_cc26xx_Power_standbyPolicy__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.defaultClockFunc", new Extern("ti_sysbios_family_arm_cc26xx_Power_defaultClockFunc__E", "xdc_Void(*)(xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.defaultNotifyTrapFunc", new Extern("ti_sysbios_family_arm_cc26xx_Power_defaultNotifyTrapFunc__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.LF_clockFunc", new Extern("ti_sysbios_family_arm_cc26xx_Power_LF_clockFunc__E", "xdc_Void(*)(xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.XOSC_HF_clockFunc", new Extern("ti_sysbios_family_arm_cc26xx_Power_XOSC_HF_clockFunc__E", "xdc_Void(*)(xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.initiateCalibration", new Extern("ti_sysbios_family_arm_cc26xx_Power_initiateCalibration__E", "xdc_Bool(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.startFirstMeasurement", new Extern("ti_sysbios_family_arm_cc26xx_Power_startFirstMeasurement__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.auxISR", new Extern("ti_sysbios_family_arm_cc26xx_Power_auxISR__E", "xdc_Void(*)(xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getClockHandle", new Extern("ti_sysbios_family_arm_cc26xx_Power_getClockHandle__E", "ti_sysbios_knl_Clock_Handle(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.doWFI", new Extern("ti_sysbios_family_arm_cc26xx_Power_doWFI__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getConstraintInfo", new Extern("ti_sysbios_family_arm_cc26xx_Power_getConstraintInfo__E", "xdc_UInt32(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getDependencyCount", new Extern("ti_sysbios_family_arm_cc26xx_Power_getDependencyCount__E", "xdc_UInt32(*)(xdc_UInt8)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getTransitionState", new Extern("ti_sysbios_family_arm_cc26xx_Power_getTransitionState__E", "ti_sysbios_family_arm_cc26xx_Power_TransitionState(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getTicksUntilWakeup", new Extern("ti_sysbios_family_arm_cc26xx_Power_getTicksUntilWakeup__E", "xdc_UInt32(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getTransitionLatency", new Extern("ti_sysbios_family_arm_cc26xx_Power_getTransitionLatency__E", "xdc_UInt32(*)(ti_sysbios_family_arm_cc26xx_Power_SleepState,ti_sysbios_family_arm_cc26xx_Power_LatencyType)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.getXoscStartupTime", new Extern("ti_sysbios_family_arm_cc26xx_Power_getXoscStartupTime__E", "xdc_UInt32(*)(xdc_UInt32)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.isStableXOSC_HF", new Extern("ti_sysbios_family_arm_cc26xx_Power_isStableXOSC_HF__E", "xdc_Bool(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.releaseConstraint", new Extern("ti_sysbios_family_arm_cc26xx_Power_releaseConstraint__E", "xdc_Void(*)(ti_sysbios_family_arm_cc26xx_Power_Constraint)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.releaseDependency", new Extern("ti_sysbios_family_arm_cc26xx_Power_releaseDependency__E", "xdc_Void(*)(xdc_UInt8)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.registerNotify", new Extern("ti_sysbios_family_arm_cc26xx_Power_registerNotify__E", "ti_sysbios_family_arm_cc26xx_Power_Status(*)(ti_sysbios_family_arm_cc26xx_Power_NotifyObj*,xdc_UInt32,xdc_Fxn,xdc_UArg,xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.setConstraint", new Extern("ti_sysbios_family_arm_cc26xx_Power_setConstraint__E", "xdc_Void(*)(ti_sysbios_family_arm_cc26xx_Power_Constraint)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.setDependency", new Extern("ti_sysbios_family_arm_cc26xx_Power_setDependency__E", "xdc_Bool(*)(xdc_UInt8)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.shutdown", new Extern("ti_sysbios_family_arm_cc26xx_Power_shutdown__E", "ti_sysbios_family_arm_cc26xx_Power_Status(*)(xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.sleep", new Extern("ti_sysbios_family_arm_cc26xx_Power_sleep__E", "ti_sysbios_family_arm_cc26xx_Power_Status(*)(ti_sysbios_family_arm_cc26xx_Power_SleepState,xdc_UArg,xdc_UArg)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.switchXOSC_HF", new Extern("ti_sysbios_family_arm_cc26xx_Power_switchXOSC_HF__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.unregisterNotify", new Extern("ti_sysbios_family_arm_cc26xx_Power_unregisterNotify__E", "xdc_Void(*)(ti_sysbios_family_arm_cc26xx_Power_NotifyObj*)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.idleCPU", new Extern("ti_sysbios_family_arm_cc26xx_Power_idleCPU__E", "xdc_Void(*)(xdc_Void)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.notify", new Extern("ti_sysbios_family_arm_cc26xx_Power_notify__I", "ti_sysbios_family_arm_cc26xx_Power_Status(*)(ti_sysbios_family_arm_cc26xx_Power_Event)", true, false));
        om.bind("ti.sysbios.family.arm.cc26xx.Power.serviceNotifyQ", new Extern("ti_sysbios_family_arm_cc26xx_Power_serviceNotifyQ__I", "ti_sysbios_family_arm_cc26xx_Power_NotifyResponse(*)(ti_sysbios_family_arm_cc26xx_Power_Event)", true, false));
    }
    ...
    void Power$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NotifyObj", "ti.sysbios.family.arm.cc26xx");
        sizes.clear();
        sizes.add(Global.newArray("link", "Sti.sysbios.knl.Queue;Elem"));
        sizes.add(Global.newArray("eventTypes", "UInt32"));
        sizes.add(Global.newArray("notifyFxn", "UFxn"));
        sizes.add(Global.newArray("clientArg", "UIArg"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.family.arm.cc26xx.Power.NotifyObj']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.family.arm.cc26xx.Power.NotifyObj']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.family.arm.cc26xx.Power.NotifyObj'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Module_State", "ti.sysbios.family.arm.cc26xx");
        sizes.clear();
        sizes.add(Global.newArray("constraintsMask", "UInt32"));
        sizes.add(Global.newArray("state", "Nti.sysbios.family.arm.cc26xx.Power.TransitionState;;0x1;0x2;0x3;0x4"));
        sizes.add(Global.newArray("xoscPending", "UShort"));
        sizes.add(Global.newArray("notifyQ", "Sti.sysbios.knl.Queue;Instance_State"));
        sizes.add(Global.newArray("clockObj", "Sti.sysbios.knl.Clock;Instance_State"));
        sizes.add(Global.newArray("xoscClockObj", "Sti.sysbios.knl.Clock;Instance_State"));
        sizes.add(Global.newArray("lfClockObj", "Sti.sysbios.knl.Clock;Instance_State"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sysbios.family.arm.cc26xx.Power.Module_State']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sysbios.family.arm.cc26xx.Power.Module_State']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sysbios.family.arm.cc26xx.Power.Module_State'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void Boot$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("checkBackdoor", $$T_Bool, false, "wh");
            po.addFld("overrideDefaultBackdoorIOID", $$T_Bool, false, "w");
            po.addFld("alternateBackdoorIOID", Proto.Elm.newCNum("(xdc_UInt32)"), 0L, "w");
    ...
    void Power$$TYPES()
    {
        ...
        po.init("ti.sysbios.family.arm.cc26xx.Power.Module", om.findStrict("ti.sysbios.interfaces.IPower.Module", "ti.sysbios.family.arm.cc26xx"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
            po.addFld("A_tooManyCallsReleaseConstraint", (Proto)om.findStrict("xdc.runtime.Assert$$Id", "ti.sysbios.family.arm.cc26xx"), Global.newObject("msg", "A_tooManyCallsReleaseConstraint: Power_releaseConstraint() called too many times for this constraint."), "w");
            po.addFld("A_tooManyCallsReleaseDependency", (Proto)om.findStrict("xdc.runtime.Assert$$Id", "ti.sysbios.family.arm.cc26xx"), Global.newObject("msg", "A_tooManyCallsReleaseDependency: Power_releaseDependency() called too many times for this resource."), "w");
            po.addFld("idle", $$T_Bool, false, "w");
            po.addFld("resumeSTANDBY", Proto.Elm.newCNum("(xdc_UInt)"), 750L, "wh");
            po.addFld("resumeTicksSTANDBY", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
            po.addFld("totalSTANDBY", Proto.Elm.newCNum("(xdc_UInt)"), 1000L, "wh");
            po.addFld("totalTicksSTANDBY", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
            po.addFld("wakeDelaySTANDBY", Proto.Elm.newCNum("(xdc_UInt)"), 130L, "w");
            po.addFld("initialWaitXOSC_HF", Proto.Elm.newCNum("(xdc_UInt)"), 50L, "w");
            po.addFld("retryWaitXOSC_HF", Proto.Elm.newCNum("(xdc_UInt)"), 50L, "w");
            po.addFld("calibrateRCOSC", $$T_Bool, true, "w");
            po.addFld("enableVCOLDOPG2", $$T_Bool, false, "w");
            po.addFld("clockFunc", new Proto.Adr("xdc_Void(*)(xdc_UArg)", "PFv"), om.find("ti.sysbios.family.arm.cc26xx.Power.defaultClockFunc"), "w");
            po.addFld("lfClockFunc", new Proto.Adr("xdc_Void(*)(xdc_UArg)", "PFv"), om.find("ti.sysbios.family.arm.cc26xx.Power.LF_clockFunc"), "w");
            po.addFld("xoscClockFunc", new Proto.Adr("xdc_Void(*)(xdc_UArg)", "PFv"), om.find("ti.sysbios.family.arm.cc26xx.Power.XOSC_HF_clockFunc"), "w");
            po.addFld("policyFunc", new Proto.Adr("xdc_Void(*)(xdc_Void)", "PFv"), om.find("ti.sysbios.family.arm.cc26xx.Power.doWFI"), "wh");
            po.addFld("notifyTrapFunc", new Proto.Adr("xdc_Void(*)(xdc_Void)", "PFv"), om.find("ti.sysbios.family.arm.cc26xx.Power.defaultNotifyTrapFunc"), "w");
            po.addFld("rovViewInfo", (Proto)om.findStrict("xdc.rov.ViewInfo.Instance", "ti.sysbios.family.arm.cc26xx"), $$UNDEF, "wh");
        }//isCFG
        fxn = Global.get(cap, "module$use");
        ...
        if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$static$init");
        if (fxn != null) om.bind("ti.sysbios.family.arm.cc26xx.Power$$module$static$init", true);
        if (fxn != null) po.addFxn("module$static$init", $$T_Met, fxn);
        fxn = Global.get(cap, "module$validate");
        ...
        // struct Power.NotifyObj
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc26xx.Power$$NotifyObj", "ti.sysbios.family.arm.cc26xx");
        po.init("ti.sysbios.family.arm.cc26xx.Power.NotifyObj", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("link", (Proto)om.findStrict("ti.sysbios.knl.Queue.Elem", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "w");
                po.addFld("eventTypes", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("notifyFxn", new Proto.Adr("xdc_Fxn", "Pf"), $$UNDEF, "w");
                po.addFld("clientArg", new Proto.Adr("xdc_UArg", "Pv"), $$UNDEF, "w");
        // struct Power.ModuleView
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc26xx.Power$$ModuleView", "ti.sysbios.family.arm.cc26xx");
        po.init("ti.sysbios.family.arm.cc26xx.Power.ModuleView", null);
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("ConstraintsMask", $$T_Str, $$UNDEF, "w");
                po.addFxn("$xml", $$T_Met, Global.get("$$xml"));
        // struct Power.Module_State
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc26xx.Power$$Module_State", "ti.sysbios.family.arm.cc26xx");
        po.init("ti.sysbios.family.arm.cc26xx.Power.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("constraintsMask", Proto.Elm.newCNum("(xdc_UInt32)"), $$UNDEF, "w");
                po.addFld("state", (Proto)om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TransitionState", "ti.sysbios.family.arm.cc26xx"), $$UNDEF, "w");
                po.addFld("xoscPending", $$T_Bool, $$UNDEF, "w");
                po.addFldV("notifyQ", (Proto)om.findStrict("ti.sysbios.knl.Queue.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_notifyQ", (Proto)om.findStrict("ti.sysbios.knl.Queue.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "w");
                po.addFldV("clockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_clockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "w");
                po.addFldV("xoscClockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_xoscClockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "w");
                po.addFldV("lfClockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "wh", $$objFldGet, $$objFldSet);
                po.addFld("Object_field_lfClockObj", (Proto)om.findStrict("ti.sysbios.knl.Clock.Object", "ti.sysbios.family.arm.cc26xx"), $$DEFAULT, "w");
    }
    ...
    void Power$$ROV()
    {
        ...
        vo.bind("NotifyObj$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.cc26xx.Power.NotifyObj", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc26xx.Power$$NotifyObj", "ti.sysbios.family.arm.cc26xx");
        vo.bind("Module_State$fetchDesc", Global.newObject("type", "ti.sysbios.family.arm.cc26xx.Power.Module_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sysbios.family.arm.cc26xx.Power$$Module_State", "ti.sysbios.family.arm.cc26xx");
    }
    ...
    void Boot$$SINGLETONS()
    {
        ...
        mcfgs.add("Object__table");
        icfgs.add("Object__table");
        mcfgs.add("overrideDefaultBackdoorIOID");
        mcfgs.add("alternateBackdoorIOID");
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
    ...
    void Power$$SINGLETONS()
    {
        ...
        vo.bind("Constraint", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Constraint", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("LatencyType", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.LatencyType", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SleepState", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SleepState", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("Event", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Event", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NotifyResponse", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NotifyResponse", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("Status", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Status", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("TransitionState", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TransitionState", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NotifyObj", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NotifyObj", "ti.sysbios.family.arm.cc26xx"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NotifyObj", "ti.sysbios.family.arm.cc26xx"));
        mcfgs.add("A_tooManyCallsReleaseConstraint");
        mcfgs.add("A_tooManyCallsReleaseDependency");
        mcfgs.add("resumeTicksSTANDBY");
        mcfgs.add("totalTicksSTANDBY");
        mcfgs.add("wakeDelaySTANDBY");
        mcfgs.add("initialWaitXOSC_HF");
        mcfgs.add("retryWaitXOSC_HF");
        mcfgs.add("calibrateRCOSC");
        mcfgs.add("enableVCOLDOPG2");
        mcfgs.add("clockFunc");
        mcfgs.add("lfClockFunc");
        mcfgs.add("xoscClockFunc");
        mcfgs.add("notifyTrapFunc");
        vo.bind("ModuleView", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ModuleView", "ti.sysbios.family.arm.cc26xx"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ModuleView", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("Module_State", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Module_State", "ti.sysbios.family.arm.cc26xx"));
        tdefs.add(om.findStrict("ti.sysbios.family.arm.cc26xx.Power.Module_State", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SB_VIMS_CACHE_RETAIN", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SB_VIMS_CACHE_RETAIN", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SD_DISALLOW", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SD_DISALLOW", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SB_DISALLOW", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SB_DISALLOW", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("IDLE_PD_DISALLOW", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.IDLE_PD_DISALLOW", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NEED_FLASH_IN_IDLE", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NEED_FLASH_IN_IDLE", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NUMCONSTRAINTS", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NUMCONSTRAINTS", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("TOTAL", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.TOTAL", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("RESUME", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.RESUME", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("STANDBY", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.STANDBY", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("ENTERING_STANDBY", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ENTERING_STANDBY", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("ENTERING_SHUTDOWN", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ENTERING_SHUTDOWN", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("AWAKE_STANDBY", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.AWAKE_STANDBY", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("AWAKE_STANDBY_LATE", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.AWAKE_STANDBY_LATE", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("XOSC_HF_SWITCHED", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.XOSC_HF_SWITCHED", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NUMEVENTS", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NUMEVENTS", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NOTIFYDONE", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NOTIFYDONE", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("NOTIFYERROR", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.NOTIFYERROR", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SOK", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SOK", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SOK_STATE_RESTORED", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SOK_STATE_RESTORED", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("EFAIL", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.EFAIL", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("EINVALIDPOINTER", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.EINVALIDPOINTER", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("ECHANGE_NOT_ALLOWED", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ECHANGE_NOT_ALLOWED", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("ETIMEOUT", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ETIMEOUT", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("EBUSY", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.EBUSY", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("ACTIVE", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ACTIVE", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("ENTERING_SLEEP", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.ENTERING_SLEEP", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("EXITING_SLEEP", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.EXITING_SLEEP", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("SHUTDOWN", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.SHUTDOWN", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        ...
        vo.bind("standbyPolicy", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.standbyPolicy", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("defaultClockFunc", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.defaultClockFunc", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("defaultNotifyTrapFunc", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.defaultNotifyTrapFunc", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("LF_clockFunc", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.LF_clockFunc", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("XOSC_HF_clockFunc", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.XOSC_HF_clockFunc", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("initiateCalibration", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.initiateCalibration", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("startFirstMeasurement", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.startFirstMeasurement", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("auxISR", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.auxISR", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getClockHandle", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getClockHandle", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("doWFI", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.doWFI", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getConstraintInfo", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getConstraintInfo", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getDependencyCount", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getDependencyCount", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getTransitionState", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getTransitionState", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getTicksUntilWakeup", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getTicksUntilWakeup", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getTransitionLatency", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getTransitionLatency", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("getXoscStartupTime", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.getXoscStartupTime", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("isStableXOSC_HF", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.isStableXOSC_HF", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("releaseConstraint", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.releaseConstraint", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("releaseDependency", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.releaseDependency", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("registerNotify", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.registerNotify", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("setConstraint", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.setConstraint", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("setDependency", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.setDependency", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("shutdown", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.shutdown", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("sleep", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.sleep", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("switchXOSC_HF", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.switchXOSC_HF", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("unregisterNotify", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.unregisterNotify", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("idleCPU", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.idleCPU", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("notify", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.notify", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("serviceNotifyQ", om.findStrict("ti.sysbios.family.arm.cc26xx.Power.serviceNotifyQ", "ti.sysbios.family.arm.cc26xx"));
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_cc26xx_Power_Module__startupDone__E", "ti_sysbios_family_arm_cc26xx_Power_standbyPolicy__E", "ti_sysbios_family_arm_cc26xx_Power_defaultClockFunc__E", "ti_sysbios_family_arm_cc26xx_Power_defaultNotifyTrapFunc__E", "ti_sysbios_family_arm_cc26xx_Power_LF_clockFunc__E", "ti_sysbios_family_arm_cc26xx_Power_XOSC_HF_clockFunc__E", "ti_sysbios_family_arm_cc26xx_Power_initiateCalibration__E", "ti_sysbios_family_arm_cc26xx_Power_startFirstMeasurement__E", "ti_sysbios_family_arm_cc26xx_Power_auxISR__E", "ti_sysbios_family_arm_cc26xx_Power_getClockHandle__E", "ti_sysbios_family_arm_cc26xx_Power_doWFI__E", "ti_sysbios_family_arm_cc26xx_Power_getConstraintInfo__E", "ti_sysbios_family_arm_cc26xx_Power_getDependencyCount__E", "ti_sysbios_family_arm_cc26xx_Power_getTransitionState__E", "ti_sysbios_family_arm_cc26xx_Power_getTicksUntilWakeup__E", "ti_sysbios_family_arm_cc26xx_Power_getTransitionLatency__E", "ti_sysbios_family_arm_cc26xx_Power_getXoscStartupTime__E", "ti_sysbios_family_arm_cc26xx_Power_isStableXOSC_HF__E", "ti_sysbios_family_arm_cc26xx_Power_releaseConstraint__E", "ti_sysbios_family_arm_cc26xx_Power_releaseDependency__E", "ti_sysbios_family_arm_cc26xx_Power_registerNotify__E", "ti_sysbios_family_arm_cc26xx_Power_setConstraint__E", "ti_sysbios_family_arm_cc26xx_Power_setDependency__E", "ti_sysbios_family_arm_cc26xx_Power_shutdown__E", "ti_sysbios_family_arm_cc26xx_Power_sleep__E", "ti_sysbios_family_arm_cc26xx_Power_switchXOSC_HF__E", "ti_sysbios_family_arm_cc26xx_Power_unregisterNotify__E", "ti_sysbios_family_arm_cc26xx_Power_idleCPU__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray("A_tooManyCallsReleaseConstraint", "A_tooManyCallsReleaseDependency"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
    ...
    void Seconds$$SINGLETONS()
    {
        ...
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_cc26xx_Seconds_Module__startupDone__E", "ti_sysbios_family_arm_cc26xx_Seconds_get__E", "ti_sysbios_family_arm_cc26xx_Seconds_set__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
