...
*  This example was designed to use a CC3100 evaluation module (CC3100 BP).
   The booster pack is required to successfully complete this example.
   A wireless router or access point (AP) is also required for this example.

** This example uses the CC3100's SmartConfig technology to connect to a
   wireless network.  A SmartConfig application will be required to complete
...
the application instructions to connect the CC3100 to your AP.  Once connected,
the CC3100's IP address is printed on the console and Board_LED1 is ON.  The
