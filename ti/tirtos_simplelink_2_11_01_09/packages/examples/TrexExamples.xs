...
function module$meta$init()
{
    ...
    for(var i = 0; i < biosExamples.templateArr.length; i++) {
        ...
        if (biosExamples.templateArr[i].linkerBuildOptions != undefined &&
            ...
            biosExamples.templateArr[i].linkerBuildOptions =
                biosExamples.templateArr[i].linkerBuildOptions.replace("{BIOS_CG_ROOT}", tirtosBIOSDir);
        }
    ...
    for(var i = 0; i < uiaExamples.templateArr.length; i++) {
        ...
        if (uiaExamples.templateArr[i].linkerBuildOptions != undefined &&
            ...
            uiaExamples.templateArr[i].linkerBuildOptions =
                uiaExamples.templateArr[i].linkerBuildOptions.replace("{BIOS_CG_ROOT}", tirtosBIOSDir);
        }
    ...
    /* EK-LM4F120XL Groups */
    Examples.templateGroupArr.$add({
        id          : rootString + ".driver.EK_LM4F120XL.example",
        name        : "Example Projects",
        description : "TI-RTOS Example Projects for the EK_LM4F120XL",
        groups      : [rootString + ".driver.EK_LM4F120XL"]
    });
    /* EKS-LM4F232 Groups */
    Examples.templateGroupArr.$add({
        id          : rootString + ".driver.EKS_LM4F232.example",
        name        : "Example Projects",
        description : "TI-RTOS Example Projects for the EKS_LM4F232",
        groups      : [rootString + ".driver.EKS_LM4F232"]
    });
    /* CC3200_LP Groups */
    Examples.templateGroupArr.$add({
    ...
    Examples.templateGroupArr.$add({
        ...
        name        : "Example Projects",
        description : "TI-RTOS Example Projects for the CC2650EM on the SmartRF06 evalation board",
    ...
    Examples.templateGroupArr.$add({
        ...
        name        : "Example Projects",
        description : "TI-RTOS Example Projects for the CC2650 Sensor Tag evalation board",
