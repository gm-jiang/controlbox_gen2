...
public class ti_tirtos
{
    ...
    void $$IMPORTS()
    {
        ...
        Global.callFxn("loadPackage", xdcO, "ti.sysbios.fatfs");
    ...
    void TIRTOS$$TYPES()
    {
        ...
        po.addFld("supportsEMAC", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsGPIO", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsI2C", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsPWM", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsSDSPI", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsSPI", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsUART", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsUSBMSCHFatFs", $$T_Bool, $$UNDEF, "wh");
        po.addFld("supportsWatchdog", $$T_Bool, $$UNDEF, "wh");
    ...
    void $$SINGLETONS()
    {
        ...
        imports.add(Global.newArray("ti.sysbios.fatfs", Global.newArray()));
