...
public class ti_tirtos_productview
{
    ...
    void TIRTOSProductView$$TYPES()
    {
        ...
        po.addFld("linksToArray", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{"com.ti.rtsc.SYSBIOS", "com.ti.rtsc.NDK", "com.ti.uia", "com.ti.rtsc.IPC"}), "wh");
        ...
        po.addFld("ti_drivers_EMAC", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_GPIO", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_I2C", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_PWM", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_SDSPI", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_SPI", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_UART", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_USBMSCHFatFs", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_Watchdog", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
        po.addFld("ti_drivers_WiFi", (Proto)om.findStrict("ti.tirtos.productview.TIRTOSProductView.ProductElemDesc", "ti.tirtos.productview"), $$DEFAULT, "wh");
