...
public class ti_drivers
{
    ...
    void GPIO$$OBJECTS()
    {
        ...
        om.bind("ti.drivers.GPIO.GPIO_Direction", new Proto.Enm("ti.drivers.GPIO.GPIO_Direction"));
        spo = (Proto.Obj)om.bind("ti.drivers.GPIO$$GPIO_HWAttrs", new Proto.Obj());
        om.bind("ti.drivers.GPIO.GPIO_HWAttrs", new Proto.Str(spo, false));
    ...
    void WiFi$$OBJECTS()
    {
        ...
        om.bind("ti.drivers.WiFi.HDType", new Proto.Enm("ti.drivers.WiFi.HDType"));
        om.bind("ti.drivers.WiFi.WiFiTivaCC3000_State", new Proto.Enm("ti.drivers.WiFi.WiFiTivaCC3000_State"));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_State", new Proto.Enm("ti.drivers.WiFi.WiFiMSP430CC3000_State"));
        ...
        spo = (Proto.Obj)om.bind("ti.drivers.WiFi$$WiFiTivaCC3000_HWAttrs", new Proto.Obj());
        om.bind("ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.drivers.WiFi$$WiFiMSP430CC3000_HWAttrs", new Proto.Obj());
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.drivers.WiFi$$WiFiTivaCC3000_Object", new Proto.Obj());
        om.bind("ti.drivers.WiFi.WiFiTivaCC3000_Object", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.drivers.WiFi$$WiFiMSP430CC3000_Object", new Proto.Obj());
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_Object", new Proto.Str(spo, false));
    ...
    void GPIO$$CONSTS()
    {
        ...
        om.bind("ti.drivers.GPIO.GPIO_OUTPUT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.GPIO.GPIO_Direction", "ti.drivers"), "ti.drivers.GPIO.GPIO_OUTPUT", 0));
        om.bind("ti.drivers.GPIO.GPIO_INPUT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.GPIO.GPIO_Direction", "ti.drivers"), "ti.drivers.GPIO.GPIO_INPUT", 1));
    }
    ...
    {
        // module WiFi
        om.bind("ti.drivers.WiFi.DeviceType_SimpleLink_CC3000", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.DeviceType", "ti.drivers"), "ti.drivers.WiFi.DeviceType_SimpleLink_CC3000", 0));
        om.bind("ti.drivers.WiFi.DeviceType_SimpleLink_CC3100", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.DeviceType", "ti.drivers"), "ti.drivers.WiFi.DeviceType_SimpleLink_CC3100", 1));
        ...
        om.bind("ti.drivers.WiFi.HDType_SingleThread", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.HDType", "ti.drivers"), "ti.drivers.WiFi.HDType_SingleThread", 0));
        om.bind("ti.drivers.WiFi.HDType_MultiThread", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.HDType", "ti.drivers"), "ti.drivers.WiFi.HDType_MultiThread", 1));
        om.bind("ti.drivers.WiFi.STATE_POWERUP", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_POWERUP", 0));
        om.bind("ti.drivers.WiFi.STATE_INITIALIZED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_INITIALIZED", 1));
        om.bind("ti.drivers.WiFi.STATE_IDLE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_IDLE", 2));
        om.bind("ti.drivers.WiFi.STATE_WRITE_FIRST_PART", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_WRITE_FIRST_PART", 3));
        om.bind("ti.drivers.WiFi.STATE_WRITE_EOT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_WRITE_EOT", 4));
        om.bind("ti.drivers.WiFi.STATE_READ_IRQ", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_READ_IRQ", 5));
        om.bind("ti.drivers.WiFi.STATE_READ_FIRST_PART", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_READ_FIRST_PART", 6));
        om.bind("ti.drivers.WiFi.STATE_READ_EOT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), "ti.drivers.WiFi.STATE_READ_EOT", 7));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_POWERUP", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), "ti.drivers.WiFi.WiFiMSP430CC3000_STATE_POWERUP", 0));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_INITIALIZED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), "ti.drivers.WiFi.WiFiMSP430CC3000_STATE_INITIALIZED", 1));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_IDLE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), "ti.drivers.WiFi.WiFiMSP430CC3000_STATE_IDLE", 2));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_WRITE_EOT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), "ti.drivers.WiFi.WiFiMSP430CC3000_STATE_WRITE_EOT", 3));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_READ_IRQ", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), "ti.drivers.WiFi.WiFiMSP430CC3000_STATE_READ_IRQ", 4));
        om.bind("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_READ_EOT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), "ti.drivers.WiFi.WiFiMSP430CC3000_STATE_READ_EOT", 5));
        om.bind("ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_State", "ti.drivers"), "ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", xdc.services.intern.xsr.Enum.intValue(0L)+0));
        om.bind("ti.drivers.WiFi.WiFiCC3100_SPI_IDLE", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_State", "ti.drivers"), "ti.drivers.WiFi.WiFiCC3100_SPI_IDLE", xdc.services.intern.xsr.Enum.intValue(om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", "ti.drivers"))+1));
        om.bind("ti.drivers.WiFi.WiFiCC3100_SPI_READ_EOT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_State", "ti.drivers"), "ti.drivers.WiFi.WiFiCC3100_SPI_READ_EOT", xdc.services.intern.xsr.Enum.intValue(om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", "ti.drivers"))+2));
        om.bind("ti.drivers.WiFi.WiFiCC3100_SPI_READ_MSG", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_State", "ti.drivers"), "ti.drivers.WiFi.WiFiCC3100_SPI_READ_MSG", xdc.services.intern.xsr.Enum.intValue(om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", "ti.drivers"))+3));
        om.bind("ti.drivers.WiFi.WiFiCC3100_SPI_WRITE_EOT", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_State", "ti.drivers"), "ti.drivers.WiFi.WiFiCC3100_SPI_WRITE_EOT", xdc.services.intern.xsr.Enum.intValue(om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", "ti.drivers"))+4));
        om.bind("ti.drivers.WiFi.WiFiCC3100_SPI_WRITE_MSG", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_State", "ti.drivers"), "ti.drivers.WiFi.WiFiCC3100_SPI_WRITE_MSG", xdc.services.intern.xsr.Enum.intValue(om.findStrict("ti.drivers.WiFi.WiFiCC3100_SPI_UNINITIALIZED", "ti.drivers"))+5));
    }
    ...
    void GPIO$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.drivers.GPIO.GPIO_HWAttrs", "ti.drivers");
        sizes.clear();
        sizes.add(Global.newArray("port", "ULong"));
        sizes.add(Global.newArray("pin", "UInt32"));
        sizes.add(Global.newArray("direction", "Nti.drivers.GPIO.GPIO_Direction;;;"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.drivers.GPIO.GPIO_HWAttrs']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.drivers.GPIO.GPIO_HWAttrs']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.drivers.GPIO.GPIO_HWAttrs'], fld); }");
        so.bind("$offsetof", fxn);
    ...
    void WiFi$$SIZES()
    {
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs", "ti.drivers");
        sizes.clear();
        sizes.add(Global.newArray("irqPort", "ULong"));
        sizes.add(Global.newArray("irqPin", "UInt32"));
        sizes.add(Global.newArray("irqIntNum", "TInt"));
        sizes.add(Global.newArray("csPort", "ULong"));
        sizes.add(Global.newArray("csPin", "UInt32"));
        sizes.add(Global.newArray("enPort", "ULong"));
        sizes.add(Global.newArray("enPin", "UInt32"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs", "ti.drivers");
        sizes.clear();
        sizes.add(Global.newArray("irqPort", "ULong"));
        sizes.add(Global.newArray("irqPin", "UInt32"));
        sizes.add(Global.newArray("csPort", "ULong"));
        ...
        sizes.add(Global.newArray("enPin", "UInt32"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_Object", "ti.drivers");
        sizes.clear();
        sizes.add(Global.newArray("writeCompleteSem", "UPtr"));
        sizes.add(Global.newArray("hwiIrq", "UPtr"));
        sizes.add(Global.newArray("spiHandle", "UPtr"));
        sizes.add(Global.newArray("spiRxHandler", "UPtr"));
        sizes.add(Global.newArray("spiState", "Nti.drivers.WiFi.WiFiTivaCC3000_State;;;;;;;;;"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.drivers.WiFi.WiFiTivaCC3000_Object']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.drivers.WiFi.WiFiTivaCC3000_Object']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.drivers.WiFi.WiFiTivaCC3000_Object'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_Object", "ti.drivers");
        sizes.clear();
        sizes.add(Global.newArray("writeCompleteSem", "UPtr"));
        sizes.add(Global.newArray("spiHandle", "UPtr"));
        sizes.add(Global.newArray("spiRxHandler", "UPtr"));
        sizes.add(Global.newArray("spiState", "Nti.drivers.WiFi.WiFiMSP430CC3000_State;;;;;;;"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.drivers.WiFi.WiFiMSP430CC3000_Object']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.drivers.WiFi.WiFiMSP430CC3000_Object']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.drivers.WiFi.WiFiMSP430CC3000_Object'], fld); }");
        so.bind("$offsetof", fxn);
        ...
        sizes.add(Global.newArray("spiState", "Nti.drivers.WiFi.WiFiCC3100_SPI_State;;0;;;;;"));
        sizes.add(Global.newArray("isOpen", "UShort"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
    ...
    void GPIO$$TYPES()
    {
        ...
        if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
        // struct GPIO.GPIO_HWAttrs
        po = (Proto.Obj)om.findStrict("ti.drivers.GPIO$$GPIO_HWAttrs", "ti.drivers");
        po.init("ti.drivers.GPIO.GPIO_HWAttrs", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("port", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("pin", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
                po.addFld("direction", (Proto)om.findStrict("ti.drivers.GPIO.GPIO_Direction", "ti.drivers"), $$UNDEF, "w");
        ...
        po.init("ti.drivers.GPIO.GPIO_Config", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("hwAttrs", new Proto.Adr("ti_drivers_GPIO_GPIO_HWAttrs*", "PS"), $$UNDEF, "w");
    ...
    void WiFi$$TYPES()
    {
        ...
        po.init("ti.drivers.WiFi.Module", om.findStrict("xdc.runtime.IModule.Module", "ti.drivers"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
            po.addFld("deviceType", (Proto)om.findStrict("ti.drivers.WiFi.DeviceType", "ti.drivers"), om.find("ti.drivers.WiFi.DeviceType_SimpleLink_CC3000"), "wh");
            po.addFld("libType", (Proto)om.findStrict("ti.drivers.WiFi.LibType", "ti.drivers"), om.find("ti.drivers.WiFi.LibType_Instrumented"), "wh");
            po.addFld("hdType", (Proto)om.findStrict("ti.drivers.WiFi.HDType", "ti.drivers"), om.find("ti.drivers.WiFi.HDType_SingleThread"), "wh");
            po.addFld("txPayloadSize", Proto.Elm.newCNum("(xdc_Int)"), 1460L, "wh");
            po.addFld("rxPayloadSize", Proto.Elm.newCNum("(xdc_Int)"), 1460L, "wh");
            po.addFld("selectThreadPriority", Proto.Elm.newCNum("(xdc_Int)"), 1L, "wh");
        ...
        po.init("ti.drivers.WiFi.WiFi_Config", null);
                ...
                po.addFld("object", new Proto.Adr("xdc_Void*", "Pv"), $$UNDEF, "w");
                po.addFld("hwAttrs", new Proto.Adr("xdc_Void*", "Pv"), $$UNDEF, "w");
        // struct WiFi.WiFiTivaCC3000_HWAttrs
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiTivaCC3000_HWAttrs", "ti.drivers");
        po.init("ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("irqPort", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("irqPin", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
                po.addFld("irqIntNum", Proto.Elm.newCNum("(xdc_Int)"), $$UNDEF, "w");
                po.addFld("csPort", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("csPin", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
                po.addFld("enPort", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("enPin", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
        // struct WiFi.WiFiMSP430CC3000_HWAttrs
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiMSP430CC3000_HWAttrs", "ti.drivers");
        po.init("ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("irqPort", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("irqPin", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
                po.addFld("csPort", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                ...
                po.addFld("enPort", Proto.Elm.newCNum("(xdc_ULong)"), $$UNDEF, "w");
                po.addFld("enPin", Proto.Elm.newCNum("(xdc_Bits32)"), $$UNDEF, "w");
        // struct WiFi.WiFiTivaCC3000_Object
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiTivaCC3000_Object", "ti.drivers");
        po.init("ti.drivers.WiFi.WiFiTivaCC3000_Object", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("writeCompleteSem", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("hwiIrq", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("spiHandle", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("spiRxHandler", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("spiState", (Proto)om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"), $$UNDEF, "w");
        // struct WiFi.WiFiMSP430CC3000_Object
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiMSP430CC3000_Object", "ti.drivers");
        po.init("ti.drivers.WiFi.WiFiMSP430CC3000_Object", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("writeCompleteSem", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("spiHandle", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("spiRxHandler", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
                po.addFld("spiState", (Proto)om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"), $$UNDEF, "w");
    ...
    void GPIO$$ROV()
    {
        ...
        vo.bind("GPIO_HWAttrs$fetchDesc", Global.newObject("type", "ti.drivers.GPIO.GPIO_HWAttrs", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.drivers.GPIO$$GPIO_HWAttrs", "ti.drivers");
        vo.bind("GPIO_Config$fetchDesc", Global.newObject("type", "ti.drivers.GPIO.GPIO_Config", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.drivers.GPIO$$GPIO_Config", "ti.drivers");
        po.bind("hwAttrs$fetchDesc", Global.newObject("type", "ti.drivers.GPIO.GPIO_HWAttrs", "isScalar", false));
    }
    ...
    void WiFi$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFi_Config", "ti.drivers");
        vo.bind("WiFiTivaCC3000_HWAttrs$fetchDesc", Global.newObject("type", "ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiTivaCC3000_HWAttrs", "ti.drivers");
        vo.bind("WiFiMSP430CC3000_HWAttrs$fetchDesc", Global.newObject("type", "ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiMSP430CC3000_HWAttrs", "ti.drivers");
        vo.bind("WiFiTivaCC3000_Object$fetchDesc", Global.newObject("type", "ti.drivers.WiFi.WiFiTivaCC3000_Object", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiTivaCC3000_Object", "ti.drivers");
        vo.bind("WiFiMSP430CC3000_Object$fetchDesc", Global.newObject("type", "ti.drivers.WiFi.WiFiMSP430CC3000_Object", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.drivers.WiFi$$WiFiMSP430CC3000_Object", "ti.drivers");
    ...
    void GPIO$$SINGLETONS()
    {
        ...
        vo.bind("GPIO_Direction", om.findStrict("ti.drivers.GPIO.GPIO_Direction", "ti.drivers"));
        vo.bind("GPIO_HWAttrs", om.findStrict("ti.drivers.GPIO.GPIO_HWAttrs", "ti.drivers"));
        tdefs.add(om.findStrict("ti.drivers.GPIO.GPIO_HWAttrs", "ti.drivers"));
        ...
        vo.bind("GPIO_OUTPUT", om.findStrict("ti.drivers.GPIO.GPIO_OUTPUT", "ti.drivers"));
        vo.bind("GPIO_INPUT", om.findStrict("ti.drivers.GPIO.GPIO_INPUT", "ti.drivers"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
    ...
    void WiFi$$SINGLETONS()
    {
        ...
        vo.bind("HDType", om.findStrict("ti.drivers.WiFi.HDType", "ti.drivers"));
        vo.bind("WiFiTivaCC3000_State", om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_State", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_State", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_State", "ti.drivers"));
        ...
        vo.bind("WiFiTivaCC3000_HWAttrs", om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs", "ti.drivers"));
        tdefs.add(om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_HWAttrs", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_HWAttrs", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs", "ti.drivers"));
        tdefs.add(om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_HWAttrs", "ti.drivers"));
        vo.bind("WiFiTivaCC3000_Object", om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_Object", "ti.drivers"));
        tdefs.add(om.findStrict("ti.drivers.WiFi.WiFiTivaCC3000_Object", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_Object", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_Object", "ti.drivers"));
        tdefs.add(om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_Object", "ti.drivers"));
        ...
        vo.bind("DeviceType_SimpleLink_CC3000", om.findStrict("ti.drivers.WiFi.DeviceType_SimpleLink_CC3000", "ti.drivers"));
        ...
        vo.bind("HDType_SingleThread", om.findStrict("ti.drivers.WiFi.HDType_SingleThread", "ti.drivers"));
        vo.bind("HDType_MultiThread", om.findStrict("ti.drivers.WiFi.HDType_MultiThread", "ti.drivers"));
        vo.bind("STATE_POWERUP", om.findStrict("ti.drivers.WiFi.STATE_POWERUP", "ti.drivers"));
        vo.bind("STATE_INITIALIZED", om.findStrict("ti.drivers.WiFi.STATE_INITIALIZED", "ti.drivers"));
        vo.bind("STATE_IDLE", om.findStrict("ti.drivers.WiFi.STATE_IDLE", "ti.drivers"));
        vo.bind("STATE_WRITE_FIRST_PART", om.findStrict("ti.drivers.WiFi.STATE_WRITE_FIRST_PART", "ti.drivers"));
        vo.bind("STATE_WRITE_EOT", om.findStrict("ti.drivers.WiFi.STATE_WRITE_EOT", "ti.drivers"));
        vo.bind("STATE_READ_IRQ", om.findStrict("ti.drivers.WiFi.STATE_READ_IRQ", "ti.drivers"));
        vo.bind("STATE_READ_FIRST_PART", om.findStrict("ti.drivers.WiFi.STATE_READ_FIRST_PART", "ti.drivers"));
        vo.bind("STATE_READ_EOT", om.findStrict("ti.drivers.WiFi.STATE_READ_EOT", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_STATE_POWERUP", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_POWERUP", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_STATE_INITIALIZED", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_INITIALIZED", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_STATE_IDLE", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_IDLE", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_STATE_WRITE_EOT", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_WRITE_EOT", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_STATE_READ_IRQ", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_READ_IRQ", "ti.drivers"));
        vo.bind("WiFiMSP430CC3000_STATE_READ_EOT", om.findStrict("ti.drivers.WiFi.WiFiMSP430CC3000_STATE_READ_EOT", "ti.drivers"));
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.drivers.UART", "ti.drivers");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Basic", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitBasic", "structName", "BasicView")}), Global.newArray(new Object[]{"Config", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitConfig", "structName", "ConfigView")}), Global.newArray(new Object[]{"Write Buffer", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitWriteBuffer", "structName", "BufferView")}), Global.newArray(new Object[]{"Read Buffer", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitReadBuffer", "structName", "BufferView")})}))));
        }//isCFG
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.drivers.USBMSCHFatFs", "ti.drivers");
            Global.put(vo, "rovViewInfo", Global.callFxn("create", (Scriptable)om.find("xdc.rov.ViewInfo"), Global.newObject("viewMap", Global.newArray(new Object[]{Global.newArray(new Object[]{"Basic", Global.newObject("type", om.find("xdc.rov.ViewInfo.MODULE_DATA"), "viewInitFxn", "viewInitBasic", "structName", "BasicView")})}))));
