//******************************************************************************
//! \file           ICallAddrs.h
//! \brief          Stack image address information specific to build.  Modified 
//!                 for combined single image build.
//
...
/**
 * Data structure to pass initializtion data to ZNP stack thread.
 */
...
/**
 * The entry function address of the stack thread.  Fixed at startup_entry
 * of stack thread that shares this common build.
 */
#define ICALL_STACK0_ADDR (ICall_RemoteTaskEntry) & startup_entry

/**
 * Initializer for an array of @ref ICall_RemoteTaskEntry.
 * Note: for the combined build, this array is limited to 1 entry corresponds
 * to the address of startup_entry. 
 */
 ...
 * NOTE: for this combined image build, the array has only one entry.
 */
...
/**
 * Bump these up to allow the creation of the extra NPI task for ZNP.
 */
