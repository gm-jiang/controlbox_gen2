/**************************************************************************************************
   ...
   Revised:        $Date: 2015-02-09 09:50:50 -0800 (Mon, 09 Feb 2015) $
   Revision:       $Revision: 42437 $
 ...
 * input parameters
 *
 * pExtAddr - Pointer to passed in extended address.
 *
 * output parameters
 *
 * None.
