/**************************************************************************************************
  Filename:       smartlockcontroller.c
...
/***Add begin by gmjiang 2016.1.8***/
#ifdef PRINT_DEBUG
#include "smartlockcontroller_print.h"
#endif
/***Add end by gmjiang 2016.1.8***/
 ...
 * GLOBAL VARIABLES
 */
byte SmartLockController_TaskID;

uint8 SmartLockControllerSeqNum;

uint8  SmartLockController_OnOff;

uint8 SmartLockController_LockState;

uint8 SmartLockController_LockType;

bool SmartLockController_ActuatorEnabled;
 ...
 * LOCAL VARIABLES
 */
afAddrType_t SmartLockController_DstAddr;

uint8 iToggleBuff = LIGHT_OFF;

#ifdef ZCL_EZMODE
static void SmartLockController_ProcessZDOMsgs( zdoIncomingMsg_t *pMsg );
static void SmartLockController_EZModeCB( zlcEZMode_State_t state, zclEZMode_CBData_t *pData );

static const zclEZMode_RegisterData_t SmartLockController_RegisterEZModeData =
{
  &SmartLockController_TaskID,
  SMARTLOCKCONTROLLER_EZMODE_NEXTSTATE_EVT,
  SMARTLOCKCONTROLLER_EZMODE_TIMEOUT_EVT,
  &SmartLockControllerSeqNum,
  SmartLockController_EZModeCB
};


// NOT ZCL_EZMODE, Use EndDeviceBind
#else
#define ZCLSMARTLOCKCONTROLLER_BINDINGLIST   2
static cId_t bindingOutClusters[ZCLSMARTLOCKCONTROLLER_BINDINGLIST] =
{
...
devStates_t SmartLockController_NwkState = DEV_INIT;
...
{
  SMARTLOCKCONTROLLER_ENDPOINT,                                 // Test endpoint
  &SmartLockController_TaskID,
 ...
 * LOCAL FUNCTIONS
 */
static void SmartLockController_BasicResetCB( void );
static void SmartLockController_IdentifyCB( zclIdentify_t *pCmd );
static void SmartLockController_IdentifyQueryRspCB( zclIdentifyQueryRsp_t *pRsp );
//static void SmartLockController_OnOffCB( uint8 cmd );
static void SmartLockController_ProcessIdentifyTimeChange( void );

void SmartLockController_LcdDisplayMainMode(void);
void SmartLockController_LcdDisplayHelpMode(void);
void SmartLockController_LcdDisplayPINMode(void);
void SmartLockController_LcdDisplayUpdate(void);

static void SmartLockController_ProcessAppMsg( uint8 srcEP, uint8 len, uint8 *msg );
static void SmartLockController_ProcessFoundationMsg( afAddrType_t *dstAddr, uint16 clusterID,
                                                              zclFrameHdr_t *hdr, zclParseCmd_t *pParseCmd );
static void SmartLockController_ProcessGeneralMsg( uint8 srcEP, afAddrType_t *dstAddr,
                                                           uint16 clusterID, zclFrameHdr_t *hdr, uint8 len, uint8 *data );
static void SmartLockController_ProcessGroupCmd( uint8 srcEP, afAddrType_t *dstAddr,
                                                         uint16 clusterID, zclFrameHdr_t *hdr, uint8 len, uint8 *data );
static void SmartLockController_ProcessSceneCmd( uint8 srcEP, afAddrType_t *dstAddr,
                                                         uint16 clusterID, zclFrameHdr_t *hdr, uint8 len, uint8 *data );
static void SmartLockController_ProcessClosuresMsg( uint8 srcEP, afAddrType_t *dstAddr,
                                                            uint16 clusterID, zclFrameHdr_t *hdr, uint8 len, uint8 *data );

// Functions to process ZCL Foundation incoming Command/Response messages
static void SmartLockController_ProcessIncomingMsg( zclIncomingMsg_t *msg );
#ifdef ZCL_READ
static uint8 SmartLockController_ProcessInReadRspCmd( zclIncomingMsg_t *pInMsg );
#endif
#ifdef ZCL_WRITE
static uint8 SmartLockController_ProcessInWriteRspCmd( zclIncomingMsg_t *pInMsg );
#endif
static uint8 SmartLockController_ProcessInDefaultRspCmd( zclIncomingMsg_t *pInMsg );

#ifdef ZCL_DISCOVER
static uint8 SmartLockController_ProcessInDiscAttrsRspCmd( zclIncomingMsg_t *pInMsg );
#endif

static ZStatus_t SmartLockController_DoorLockRspCB ( zclIncoming_t *pInMsg, uint8 status );
 ...
 */
static zclGeneral_AppCallbacks_t SmartLockController_CmdCallbacks =
{
  SmartLockController_BasicResetCB,           // Basic Cluster Reset command
  SmartLockController_IdentifyCB,             // Identify command
#ifdef ZCL_EZMODE
  NULL,                                               // Identify EZ-Mode Invoke command
  NULL,                                               // Identify Update Commission State command
#endif
  NULL,                                               // Identify Trigger Effect command
  SmartLockController_IdentifyQueryRspCB,     // Identify Query Response command
 ...
 */
static zclClosures_DoorLockAppCallbacks_t SmartLockController_DoorLockCmdCallbacks =
{
  NULL,                                                  // DoorLock cluster command
  SmartLockController_DoorLockRspCB,             // DoorLock Response
  NULL,
  NULL,
  NULL,
  NULL,
 ...
 * @return      none
 */
void  SmartLockController_Init( byte task_id )
{
  SmartLockController_TaskID = task_id;
  // Set destination address to indirect
  SmartLockController_DstAddr.addrMode = (afAddrMode_t)AddrNotPresent;
  SmartLockController_DstAddr.endPoint = 0;
  SmartLockController_DstAddr.addr.shortAddr = 0;

  // This app is part of the Home Automation Profile
  zclHA_Init( &SmartLockController_SimpleDesc );

  // Register the ZCL General Cluster Library callback functions
  zclGeneral_RegisterCmdCallbacks( SMARTLOCKCONTROLLER_ENDPOINT, &SmartLockController_CmdCallbacks );

  // Register the application's attribute list
  zcl_registerAttrList( SMARTLOCKCONTROLLER_ENDPOINT, SMARTLOCKCONTROLLER_MAX_ATTRIBUTES, SmartLockController_Attrs );

  // Register the Application to receive the unprocessed Foundation command/response messages
  zcl_registerForMsg( SmartLockController_TaskID );

  // Register for all key events - This app will handle all key events

  /***Modify begin by gmjiang***/
  //RegisterForKeys( SmartLockController_TaskID );
  /***Modify end by gmjiang***/

  //Register the ZCL DoorLock Cluster Library callback function
  zclClosures_RegisterDoorLockCmdCallbacks( SMARTLOCKCONTROLLER_ENDPOINT, &SmartLockController_DoorLockCmdCallbacks );
...
#ifdef ZCL_EZMODE
  // Register EZ-Mode
  zcl_RegisterEZMode( &SmartLockController_RegisterEZModeData );

  // Register with the ZDO to receive Match Descriptor Responses
  ZDO_RegisterForZDOMsg(task_id, Match_Desc_rsp);
#endif

  ZDO_RegisterForZDOMsg( SmartLockController_TaskID, End_Device_Bind_rsp );
  ZDO_RegisterForZDOMsg( SmartLockController_TaskID, Match_Desc_rsp );
 ...
 * @return      none
 */
uint16 SmartLockController_event_loop( uint8 task_id, uint16 events )
{
  ...
  {
    while ( (MSGpkt = (afIncomingMSGPacket_t *)osal_msg_receive( SmartLockController_TaskID )) )
    {
      switch ( MSGpkt->hdr.event )
      {
#ifdef ZCL_EZMODE
        case ZDO_CB_MSG:
          SmartLockController_ProcessZDOMsgs( (zdoIncomingMsg_t *)MSGpkt );
          break;
#endif

        case MT_SYS_APP_MSG:
          // Message received from MT
          SmartLockController_ProcessAppMsg( ((mtSysAppMsg_t *)MSGpkt)->endpoint,
        ...
        case ZCL_INCOMING_MSG:
          ...
          SmartLockController_ProcessIncomingMsg( (zclIncomingMsg_t *)MSGpkt );
          break;

        case ZDO_STATE_CHANGE:
          SmartLockController_NwkState = (devStates_t)(MSGpkt->hdr.status);

          // now on the network
          if ( (SmartLockController_NwkState == DEV_ZB_COORD) ||
               (SmartLockController_NwkState == DEV_ROUTER)   ||
               (SmartLockController_NwkState == DEV_END_DEVICE) )
          {
#ifndef HOLD_AUTO_START
            giDoorLockScreenMode = DOORLOCK_MAINMODE;
            SmartLockController_LcdDisplayUpdate();
#endif
#ifdef ZCL_EZMODE
  ...
  if ( events & SMARTLOCKCONTROLLER_IDENTIFY_TIMEOUT_EVT )
  {
    if ( SmartLockController_IdentifyTime > 0 )
      SmartLockController_IdentifyTime--;
    SmartLockController_ProcessIdentifyTimeChange();

    return ( events ^ SMARTLOCKCONTROLLER_IDENTIFY_TIMEOUT_EVT );
  }

  if ( events & SMARTLOCKCONTROLLER_MAIN_SCREEN_EVT )
  {
    giDoorLockScreenMode = DOORLOCK_MAINMODE;
    SmartLockController_LcdDisplayUpdate();

    return ( events ^ SMARTLOCKCONTROLLER_MAIN_SCREEN_EVT );
  }

#ifdef ZCL_EZMODE
  // going on to next state
  if ( events & SMARTLOCKCONTROLLER_EZMODE_NEXTSTATE_EVT )
  {
    zcl_EZModeAction ( EZMODE_ACTION_PROCESS, NULL );   // going on to next state
    return ( events ^ SMARTLOCKCONTROLLER_EZMODE_NEXTSTATE_EVT );
  }

  // the overall EZMode timer expired, so we timed out
  if ( events & SMARTLOCKCONTROLLER_EZMODE_TIMEOUT_EVT )
  {
    zcl_EZModeAction ( EZMODE_ACTION_TIMED_OUT, NULL ); // EZ-Mode timed out
    return ( events ^ SMARTLOCKCONTROLLER_EZMODE_TIMEOUT_EVT );
  }
#endif // ZLC_EZMODE
...
/*********************************************************************
 * @fn      SmartLockController_LcdDisplayUpdate
 *
...
void SmartLockController_LcdDisplayUpdate(void)
{
  ...
  {
    SmartLockController_LcdDisplayPINMode();
  }
  else if ( giDoorLockScreenMode == DOORLOCK_HELPMODE )
  {
    SmartLockController_LcdDisplayHelpMode();
  }
  else
  {
    SmartLockController_LcdDisplayMainMode();
  }
}

/*********************************************************************
 * @fn      SmartLockController_LcdDisplayMainMode
 *
...
void SmartLockController_LcdDisplayMainMode(void)
{
  ...
  else if ( SmartLockController_NwkState == DEV_ROUTER )
  {
    zclHA_LcdStatusLine1( ZCL_HA_DEVICE_ROUTER );
  }
  else if ( SmartLockController_NwkState == DEV_END_DEVICE )
  {
...
/*********************************************************************
 * @fn      SmartLockController_LcdDisplayHelpMode
 *
...
/*********************************************************************
 * @fn      SmartLockController_LcdDisplayPINMode
 *
...
/*********************************************************************
 * @fn      SmartLockController_ProcessAppMsg
 *
...
static void SmartLockController_ProcessAppMsg( uint8 srcEP, uint8 len, uint8 *msg )
{
  ...
  if ( zcl_ProfileCmd( hdr.fc.type ) )
  {
    ...
    else
    {
      ...
      SmartLockController_ProcessFoundationMsg( &dstAddr, clusterID, &hdr, &cmd );
    }
  }
  else
  {
    ...
    else
    {
      ...
      {
        SmartLockController_ProcessGeneralMsg( srcEP, &dstAddr, clusterID, &hdr, dataLen, pData );
      }
      else if ( ZCL_CLUSTER_ID_CLOSURES( clusterID ) )
      {
        SmartLockController_ProcessClosuresMsg( srcEP, &dstAddr, clusterID, &hdr, dataLen, pData );
      }
    }
  }
}
...
/*********************************************************************
 * @fn      SmartLockController_ProcessFoundationMsg
 *
                                                ...
                                                zclFrameHdr_t *hdr, zclParseCmd_t *pParseCmd )
{
  ...
  switch ( hdr->commandID )
  {
    ...
    case ZCL_CMD_READ:
      ...
      if ( cmd )
      {
        zcl_SendRead( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID, (zclReadCmd_t *)cmd,
    ...
    case ZCL_CMD_WRITE:
      ...
      if ( cmd )
      {
        zcl_SendWrite( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID, (zclWriteCmd_t *)cmd,
                       ZCL_FRAME_CLIENT_SERVER_DIR, hdr->fc.disableDefaultRsp, hdr->transSeqNum );
        osal_mem_free( cmd );
      }
      break;
    ...
    case ZCL_CMD_WRITE_UNDIVIDED:
      ...
      if ( cmd )
      {
        zcl_SendWriteUndivided( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID, (zclWriteCmd_t *)cmd,
                                ZCL_FRAME_CLIENT_SERVER_DIR, hdr->fc.disableDefaultRsp, hdr->transSeqNum );
        osal_mem_free( cmd );
      }
      break;
    ...
    case ZCL_CMD_WRITE_NO_RSP:
      ...
      if ( cmd )
      {
        zcl_SendWriteNoRsp( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID, (zclWriteCmd_t *)cmd,
                            ZCL_FRAME_CLIENT_SERVER_DIR, hdr->fc.disableDefaultRsp, hdr->transSeqNum );
        osal_mem_free( cmd );
      }
      break;
    ...
    case ZCL_CMD_CONFIG_REPORT:
      ...
      if ( cmd )
      {
        zcl_SendConfigReportCmd( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr,  clusterID, (zclCfgReportCmd_t *)cmd,
                                 ZCL_FRAME_CLIENT_SERVER_DIR, hdr->fc.disableDefaultRsp, hdr->transSeqNum );
        osal_mem_free( cmd );
      }
      break;
    ...
    case ZCL_CMD_READ_REPORT_CFG:
      ...
      if ( cmd )
      {
        zcl_SendReadReportCfgCmd( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID, (zclReadReportCfgCmd_t *)cmd,
                                  ZCL_FRAME_CLIENT_SERVER_DIR, hdr->fc.disableDefaultRsp, hdr->transSeqNum );
        osal_mem_free( cmd );
      }
      break;
    ...
    case ZCL_CMD_REPORT:
      ...
      if ( cmd )
      {
        zcl_SendReportCmd( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID, (zclReportCmd_t *)cmd,
                           ZCL_FRAME_CLIENT_SERVER_DIR, hdr->fc.disableDefaultRsp, hdr->transSeqNum );
        osal_mem_free( cmd );
      }
      break;
...
/*********************************************************************
 * @fn      SmartLockController_ProcessGeneralMsg
 *
                  ...
                  uint16 clusterID, zclFrameHdr_t *hdr, uint8 len, uint8 *data )
{
  switch ( clusterID )
  {
    ...
    case ZCL_CLUSTER_ID_GEN_GROUPS:
      SmartLockController_ProcessGroupCmd( srcEP, dstAddr, clusterID, hdr, len, data );
      break;
#endif // ZCL_GROUPS

#ifdef ZCL_SCENES
    case ZCL_CLUSTER_ID_GEN_SCENES:
      SmartLockController_ProcessSceneCmd( srcEP, dstAddr, clusterID, hdr, len, data  );
      break;
#endif // ZCL_SCENES
...
#ifdef ZCL_GROUPS
/*********************************************************************
 * @fn      SmartLockController_ProcessGroupCmd
 *
                  ...
                  uint16 clusterID, zclFrameHdr_t *hdr, uint8 len, uint8 *data )
{
  ...
  switch ( hdr->commandID )
  {
    ...
    default:
      // Unsupported command -- just forward it.
      zcl_SendCommand( SMARTLOCKCONTROLLER_ENDPOINT, dstAddr, clusterID,
...
#ifdef ZCL_SCENES
/*********************************************************************
 * @fn      SmartLockController_ProcessSceneCmd
 *
...
/*********************************************************************
 * @fn      SmartLockController_ProcessClosuresMsg
 *
...
/*********************************************************************
 * @fn      SmartLockController_ProcessIdentifyTimeChange
 *
...
static void SmartLockController_ProcessIdentifyTimeChange( void )
{
  if ( SmartLockController_IdentifyTime > 0 )
  {
    osal_start_timerEx( SmartLockController_TaskID, SMARTLOCKCONTROLLER_IDENTIFY_TIMEOUT_EVT, 1000 );
    HalLedBlink ( HAL_LED_4, 0xFF, HAL_LED_DEFAULT_DUTY_CYCLE, HAL_LED_DEFAULT_FLASH_TIME );
  }
  else
  {
    if ( SmartLockController_OnOff )
      HalLedSet ( HAL_LED_4, HAL_LED_MODE_ON );
    else
      HalLedSet ( HAL_LED_4, HAL_LED_MODE_OFF );
    osal_stop_timerEx( SmartLockController_TaskID, SMARTLOCKCONTROLLER_IDENTIFY_TIMEOUT_EVT );
  }
}

/*********************************************************************
 * @fn      SmartLockController_BasicResetCB
 *
...
/*********************************************************************
 * @fn      SmartLockController_IdentifyCB
 *
...
static void SmartLockController_IdentifyCB( zclIdentify_t *pCmd )
{
  SmartLockController_IdentifyTime = pCmd->identifyTime;
  SmartLockController_ProcessIdentifyTimeChange();
}

/*********************************************************************
 * @fn      SmartLockController_IdentifyQueryRspCB
 *
 * @brief   Callback from the ZCL General Cluster Library when
...
/*********************************************************************
 * @fn      SmartLockController_DoorLockRspCB
 *
 * @brief   Callback from the ZCL General Cluster Library when
...
/*********************************************************************
 * @fn      SmartLockController_ProcessIncomingMsg
 *
 ...
 * @return  none
 */
static void SmartLockController_ProcessIncomingMsg( zclIncomingMsg_t *pInMsg)
{
  switch ( pInMsg->zclHdr.commandID )
  {
#ifdef ZCL_READ
    case ZCL_CMD_READ_RSP:
      SmartLockController_ProcessInReadRspCmd( pInMsg );
      break;
#endif
#ifdef ZCL_WRITE
    case ZCL_CMD_WRITE_RSP:
      SmartLockController_ProcessInWriteRspCmd( pInMsg );
      break;
#endif
#ifdef ZCL_REPORT
    // See ZCL Test Applicaiton (zcl_testapp.c) for sample code on Attribute Reporting
    case ZCL_CMD_CONFIG_REPORT:
      //SmartLockController_ProcessInConfigReportCmd( pInMsg );
      break;

    case ZCL_CMD_CONFIG_REPORT_RSP:
      //SmartLockController_ProcessInConfigReportRspCmd( pInMsg );
      break;

    case ZCL_CMD_READ_REPORT_CFG:
      //SmartLockController_ProcessInReadReportCfgCmd( pInMsg );
      break;

    case ZCL_CMD_READ_REPORT_CFG_RSP:
      //SmartLockController_ProcessInReadReportCfgRspCmd( pInMsg );
      break;

    case ZCL_CMD_REPORT:
      //SmartLockController_ProcessInReportCmd( pInMsg );
      break;
#endif
#ifdef ZCL_DISCOVER
    case ZCL_CMD_DISCOVER_ATTRS_RSP:
      SmartLockController_ProcessInDiscAttrsRspCmd( pInMsg );
      break;
#endif
    case ZCL_CMD_DEFAULT_RSP:
      SmartLockController_ProcessInDefaultRspCmd( pInMsg );
      break;
...
#ifdef ZCL_READ
/*********************************************************************
 * @fn      SmartLockController_ProcessInReadRspCmd
 *
...
#ifdef ZCL_WRITE
/*********************************************************************
 * @fn      SmartLockController_ProcessInWriteRspCmd
 *
...
#ifdef ZCL_DISCOVER
/*********************************************************************
 * @fn      SmartLockController_ProcessInDiscAttrsRspCmd
 *
...
/*********************************************************************
 * @fn      SmartLockController_ProcessInDefaultRspCmd
 *
...
#if ZCL_EZMODE
/*********************************************************************
 * @fn      SmartLockController_ProcessZDOMsgs
 *
...
/*********************************************************************
 * @fn      SmartLockController_EZModeCB
 *
...
static void SmartLockController_EZModeCB( zlcEZMode_State_t state, zclEZMode_CBData_t *pData )
{
  ...
  if ( state == EZMODE_STATE_IDENTIFYING )
  {
    ...
    SmartLockController_IdentifyTime = (EZMODE_TIME / 1000);  // convert to seconds
    SmartLockController_ProcessIdentifyTimeChange();
  }
  ...
  if( state == EZMODE_STATE_FINISH )
  {
    ...
    SmartLockController_IdentifyTime = 0;
    SmartLockController_ProcessIdentifyTimeChange();
    ...
    osal_start_timerEx( SmartLockController_TaskID, SMARTLOCKCONTROLLER_MAIN_SCREEN_EVT, 3000 );
  }
