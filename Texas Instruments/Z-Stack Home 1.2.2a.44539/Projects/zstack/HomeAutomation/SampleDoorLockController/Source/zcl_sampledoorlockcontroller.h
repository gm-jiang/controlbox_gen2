...
#define SAMPLEDOORLOCKCONTROLLER_MAX_ATTRIBUTES     20
...
// Application Events
#define SAMPLEDOORLOCKCONTROLLER_IDENTIFY_TIMEOUT_EVT         0x0001
#define SAMPLEDOORLOCKCONTROLLER_POLL_CONTROL_TIMEOUT_EVT     0x0002
...
extern uint8  zclSampleDoorLockController_OnOff;

extern uint16 zclSampleDoorLockController_IdentifyTime;

//Door Lock Cluster Attributes
extern uint8 zclSampleDoorLockController_LockState;
extern uint8 zclSampleDoorLockController_LockType;
extern bool zclSampleDoorLockController_ActuatorEnabled;
 ...
 */
  ...
  */
extern void zclSampleDoorLockController_Init( byte task_id );
