...
#define   LOCK_ROUTER_EVENT_PERIOD_MSG        0x0080
#define   EVENT_REPORT_INFRARE                0x0100 //0X0100 has been used in infrare_power
#define   HUMAN_DETECT_EVENT_SOMEONE          0x0200
#define   HUMAN_DETECT_EVENT_NOBODY           0x0400
#define   EVENT_REPORT_DEV_META               0x0800
#define   EVENT_PRESS_KEY_SCAN                0x1000
#define   EVENT_SENSOR_HEARTBRAT              0x2000

#define   MAX_REPORT_COUNT                         3
...
#define MSG_TYPE_ROUTER_PERIOD 56
#define MSG_TYPE_POWER_PERIOD 57


#define MSG_TYPE_RESET 65
#define GET_RSSI_BYLOCK 70
#define MSG_TYPE_INFRARE 80
#define MSG_TYPE_SWITCH  81
#define MSG_TYPE_DEV_META  90
#define MSG_TYPE_POWERID_REPORT 91
#define MSG_TYPE_PANASONICID_REPORT MSG_TYPE_POWERID_REPORT
